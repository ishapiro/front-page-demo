            ...
            <v-row class=" mt-16">
                ...
                <v-col cols="12" class="py-0">
                    ...
                    <v-text-field v-model="password" :append-icon="show1 ? 'mdi-eye' : 'mdi-eye-off'"
                        ...
                        hint="At least 8 characters" counter @click:append="show1 = !show1" outlined></v-text-field>
                    <div class="text-subtitle-1 black--text text-left pb-2">
                        Forgot Your Password?
                        <router-link to="/" plain class="secondary--text text-decoration-none">
                            Reset Password
                        </router-link>
                    </div>
                </v-col>
                <v-col cols="12" class="text-center">
                    ...
                    <div class="text-subtitle-1 black--text pt-6 pb-8">
                        ...
                        <router-link to="/account" plain class="secondary--text text-decoration-none">
                            Create Account
                        </router-link>
                    </div>
                </v-col>
